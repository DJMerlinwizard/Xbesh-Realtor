...
const features = [
  {
    name: 'Real-time Reddit Monitoring',
    description: 'Our AI constantly scans Reddit for discussions about mortgages, home buying, and refinancing to find potential clients.',
    icon: (
  ...
  },
  {
    ...
    description: 'Our system automatically qualifies leads based on their comments, helping you focus on the most promising prospects.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Generate customized outreach templates based on the prospect\'s specific situation and needs.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  },
  {
    ...
    description: 'Track your lead conversion rates, engagement metrics, and ROI with our comprehensive analytics dashboard.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
const testimonials = [
  {
    body: 'LeadMine has completely transformed how I find clients. I closed 3 deals in my first month just from Reddit leads!',
    author: {
      name: 'Sarah Johnson',
      handle: 'Realtor, Century 21',
      imageUrl: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    },
  },
  {
    body: 'As a broker managing a team of 15 agents, LeadMine has been a game-changer for our lead generation strategy.',
    author: {
      name: 'Michael Rodriguez',
      handle: 'Broker, RE/MAX Elite',
      imageUrl: 'https://images.pexels.com/photos/220453/pexels-photo-220453.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
    },
  },
  {
    body: 'The quality of leads from LeadMine is exceptional. These are people actively looking for help with real estate transactions.',
    author: {
      name: 'Jennifer Wu',
      handle: 'Independent Realtor',
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <Link to="/" className="-m-1.5 p-1.5">
              <span className="sr-only">LeadMine</span>
      ...
      <main className="isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="mx-auto max-w-2xl text-center">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
                  Find Real Estate Clients on Reddit
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600">
                  LeadMine helps realtors and brokers discover potential clients discussing mortgages, home buying, and refinancing on Reddit.
                </p>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-56 lg:px-8" id="features">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-primary-600">Find clients faster</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Everything you need to grow your real estate business
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Our platform helps you find, qualify, and connect with potential clients who are actively discussing real estate needs on Reddit.
            </p>
          </div>
        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8" id="testimonials">
          <div className="relative overflow-hidden bg-gray-900 px-6 py-20 shadow-xl sm:rounded-3xl sm:px-10 sm:py-24 md:px-12 lg:px-20">
            ...
            <div className="absolute -left-80 -top-56 transform-gpu blur-3xl" aria-hidden="true">
              <div
                className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-primary-600 to-secondary-600 opacity-[0.45]"
                style={{
                  clipPath:
                    'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
                }}
            ...
            >
              <div
                className="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-r from-primary-600 to-secondary-600 opacity-25"
                style={{
                  clipPath:
                    'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)',
                }}
            ...
            <div className="relative mx-auto max-w-2xl lg:mx-0">
              <div className="text-center lg:text-left">
                ...
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  Real estate professionals across the country are growing their businesses with LeadMine.
                </p>
              </div>
              <div className="mt-16 grid grid-cols-1 gap-8 sm:grid-cols-2 sm:gap-y-12">
                {testimonials.map((testimonial) => (
                  <figure key={testimonial.author.name} className="rounded-2xl bg-white/5 p-6 shadow-md ring-1 ring-white/10">
                    <blockquote className="text-sm leading-6 text-gray-300">
                      <p>{`"${testimonial.body}"`}</p>
                    </blockquote>
                    <figcaption className="mt-6 flex items-center gap-x-4">
                      <img className="h-10 w-10 rounded-full bg-gray-800" src={testimonial.author.imageUrl} alt="" />
                      <div>
                        <div className="font-semibold text-white">{testimonial.author.name}</div>
                        <div className="text-xs text-gray-400">{testimonial.author.handle}</div>
                      </div>
                    </figcaption>
                  </figure>
                ))}
        ...
        {/* FAQ section */}
        <div className="mx-auto max-w-2xl divide-y divide-gray-900/10 px-6 pb-8 sm:pb-24 sm:pt-12 lg:max-w-7xl lg:px-8 lg:pb-32" id="faq">
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 sm:py-24 lg:px-8 lg:py-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="space-y-8">
              <span className="text-2xl font-bold text-white">LeadMine</span>
              <p className="text-sm leading-6 text-gray-300">
                Finding qualified real estate leads from Reddit discussions.
              </p>
          ...
          <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs leading-5 text-gray-400">&copy; 2023 LeadMine, Inc. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
